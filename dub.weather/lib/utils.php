...
$options = [
    "http" => [
        ...
        "method" => "GET",
        "ignore_errors" => true // чтобы обрабатывать ошибки HTTP
    ],
    "ssl" => [
        "verify_peer" => false,
...
<head>
    ...
    <style>
        ...
        .weather__title, .weather__forecast, .weather__humidity, .weather__wind {
            margin: 10px 0;
        }
    </style>
</head>
...
<script>
    ...
    fetch('http://api.openweathermap.org/data/2.5/weather?id=524901&lang=ru&appid=1291a5ecb1b186fe5acce6c23714408a')
